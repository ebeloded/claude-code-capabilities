...
For complete instructions, see [plugins.md](plugins.md).
...
* [plugins.md](plugins.md) - Package and distribute Skills
* [commands.md](commands.md) - Create custom slash commands
* [subagents.md](subagents.md) - Specialized AI assistants
